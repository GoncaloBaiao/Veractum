...
export default function HomePage() {
    ...
    fetch("/api/analyze?history=true")
      ...
      .then((data) => {
        if (data?.success && Array.isArray(data?.data)) {
          setAnalysisCount(data.data.length);
        }
      })
      .catch(() => {});
  }, [!!session?.user]);
  ...
  const caseNumber = String(analysisCount + 1).padStart(3, "0");
        ...
        >
              ...
              {[
                ...
                <div
                  ...
                  style={{
                    ...
                    borderLeft:
                      "2px solid " +
                      (hovered === "analyse" ? ACCENT + "30" : "#1a1a1a"),
                    paddingLeft: 10,
                    transition: "border-color 0.3s",
                  }}
                >
          ...
          >
            ...
            >
              ...
              >
                Review past investigations, revisit sources, and track your research over
                time.
              </p>
              <div style={{ display: "flex", flexDirection: "column", flex: 1 }}>
                {[
                  ...
                  >
                    <Redacted width={w} />
                    <span
                      style={{ fontSize: 9, color: "#2e2e2e", letterSpacing: 1 }}
                    >
                      {time}
                    </span>
                  </div>
